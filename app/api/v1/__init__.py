...
api.add_resource(Location, '/incidents/<int:incident_id>/location')#updating location
api.add_resource(Description, '/incidents/<int:incident_id>/description')# updating description
api.add_resource(UserbyUsername, '/users/<user_name>')#gets a user by their username and also enables patching

...
class TestIncidents(unittest.TestCase):
    ...
    def test_get_incident_byId(self):
        ...
        result = json.loads(response.data)
        self.assertEqual(
            result['Message'], 'The specific incident has been returned successfully')
    ...
    def test_updating_a_nonexistence_incident(self):
        ...
        self.assertEqual({'Message': 'Record not found',
    ...
    def test_delete_incident(self):
        ...
        self.assertEqual({'Message': 'Successful deletion'},
                         response.get_json())
        self.assertEqual(response.status_code, 200)
